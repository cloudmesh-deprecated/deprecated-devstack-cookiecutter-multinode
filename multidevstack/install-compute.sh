...
######################################################################
# Author      : Aravindh Varadharaju, Gregor von Laszewski
# Purpose     : Compute Script
# Description : This script is inspired by
...
case $(id -u) in
    0) 
        ...
        #echo HOST_IP=192.168.236.12 >> local.conf
        ...
        echo ADMIN_PASSWORD={{cookiecutter.admin_password}} >> local.conf
        echo MYSQL_PASSWORD={{cookiecutter.service_password}} >> local.conf
        echo RABBIT_PASSWORD={{cookiecutter.service_password}} >> local.conf
        echo SERVICE_PASSWORD={{cookiecutter.service_password}} >> local.conf
        echo SERVICE_TOKEN={{cookiecutter.service_token}} >> local.conf
